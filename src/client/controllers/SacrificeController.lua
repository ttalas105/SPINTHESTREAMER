...
buildEffectOneTimeContent = function(oneTimeId, cfg, done)
	...
	if canSac then
		...
		mainBtn.MouseButton1Click:Connect(function()
			showConfirmation("Sacrifice " .. totalNeed .. " " .. effectName .. " cards for " .. formatNumber(cfg.gems) .. " Gems?", function()
		...
		UIHelper.AddPuffyGradient(autoBtn)
		autoBtn.MouseButton1Click:Connect(function()
			requestQueueAutoFill(queueId, "effect", effectName, nil, totalNeed)
		end)
