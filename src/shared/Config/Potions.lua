...
Potions.Types = {
	Luck = {
		{ tier = 1, name = "Luck Potion 1",  multiplier = 1.2, cost = 50000,    rarity = "Common",   color = Color3.fromRGB(80, 255, 100),  imageId = "rbxassetid://117397968445761", desc = "+1.2x luck multiplier for 5m" },
		{ tier = 2, name = "Luck Potion 2",  multiplier = 2,   cost = 500000,   rarity = "Rare",     color = Color3.fromRGB(50, 220, 80),   imageId = "rbxassetid://79599948950862",  desc = "+2x luck multiplier for 5m", rebirthRequired = 3 },
		{ tier = 3, name = "Luck Potion 3",  multiplier = 4,   cost = 5000000,  rarity = "Epic",     color = Color3.fromRGB(30, 180, 60),   imageId = "rbxassetid://72042325851221", desc = "+4x luck multiplier for 5m", rebirthRequired = 8 },
	},
	Cash = {
		{ tier = 1, name = "Money Potion 1", multiplier = 1.2, cost = 50000,    rarity = "Common",   color = Color3.fromRGB(255, 220, 60),  imageId = "rbxassetid://77682596035149",  desc = "+1.2x money multiplier for 5m" },
		{ tier = 2, name = "Money Potion 2", multiplier = 2,   cost = 500000,   rarity = "Rare",     color = Color3.fromRGB(255, 190, 40),  imageId = "rbxassetid://130221704783075", desc = "+2x money multiplier for 5m", rebirthRequired = 5 },
		{ tier = 3, name = "Money Potion 3", multiplier = 4,   cost = 5000000,  rarity = "Epic",     color = Color3.fromRGB(255, 160, 20),  imageId = "rbxassetid://132127116771235", desc = "+4x money multiplier for 5m", rebirthRequired = 10 },
	},
}
